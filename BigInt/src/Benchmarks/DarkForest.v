...
Lemma QuinSelector_obligation1: forall (choices : F) (_in : (list F)) (index : F) (v : F), ((4%nat < (C.k - 1%nat)%Z) /\ ((^ choices) < (2%nat ^ 4%nat)%Z)) -> Forall (fun x1 => True) _in -> (Z.of_nat (length _in) = (^ choices)) -> ((^ index) < (^ choices)) -> True -> ((((^ v) < (^ choices)) /\ (v = index)) -> ((^ v) < (2%nat ^ 4%nat)%Z)).
Proof. lia. Qed.

Lemma QuinSelector_obligation2: forall (choices : F) (_in : (list F)) (index : F) (v : F), ((4%nat < (C.k - 1%nat)%Z) /\ ((^ choices) < (2%nat ^ 4%nat)%Z)) -> Forall (fun x2 => True) _in -> (Z.of_nat (length _in) = (^ choices)) -> ((^ index) < (^ choices)) -> True -> ((((4%nat < (C.k - 1%nat)%Z) /\ ((^ v) < (2%nat ^ 4%nat)%Z)) /\ (v = choices)) -> ((^ v) < (2%nat ^ 4%nat)%Z)).
Proof. lia. Qed.
...
Lemma QuinSelector_obligation4_trivial: forall (choices : F) (_in : (list F)) (index : F) (lt : F) (u0 : unit) (v : F), ((4%nat < (C.k - 1%nat)%Z) /\ ((^ choices) < (2%nat ^ 4%nat)%Z)) -> Forall (fun x4 => True) _in -> (Z.of_nat (length _in) = (^ choices)) -> ((^ index) < (^ choices)) -> (((lt = 0%F) \/ (lt = 1%F)) /\ (((lt = 1%F) -> ((^ index) < (^ choices))) /\ ((lt = 0%F) -> ~((^ index) < (^ choices))))) -> (lt = 1%F) -> True -> ((((4%nat < (C.k - 1%nat)%Z) /\ ((^ v) < (2%nat ^ 4%nat)%Z)) /\ (v = choices)) -> True).
Proof. intuit. Qed.
