(** * DSL benchmark : Ed25519 (buggy versions) *)
...
Lemma fulladder_obligation0_trivial: forall (bit1 : F) (bit2 : F) (carry : F) (val : F) (v : F), True -> True -> True -> True -> True -> ((v = val) -> True).
Proof. hammer. Qed.

Lemma fulladder_obligation1_trivial: forall (bit1 : F) (bit2 : F) (carry : F) (val : F) (v : F), True -> True -> True -> True -> True -> ((v = val) -> True).
Proof. hammer. Qed.

Lemma fulladder_obligation2_trivial: forall (bit1 : F) (bit2 : F) (carry : F) (val : F) (v : F), True -> True -> True -> True -> True -> ((v = 1%F) -> True).
Proof. hammer. Qed.

Lemma fulladder_obligation3_trivial: forall (bit1 : F) (bit2 : F) (carry : F) (val : F) (v : F), True -> True -> True -> True -> True -> ((v = (val - 1%F)%F) -> True).
Proof. hammer. Qed.

Lemma fulladder_obligation4_trivial: forall (bit1 : F) (bit2 : F) (carry : F) (val : F) (u0 : unit) (carry_out : F) (v : F), True -> True -> True -> True -> ((val * (val - 1%F)%F)%F = 0%F) -> True -> True -> ((v = carry_out) -> True).
Proof. hammer. Qed.

Lemma fulladder_obligation5_trivial: forall (bit1 : F) (bit2 : F) (carry : F) (val : F) (u0 : unit) (carry_out : F) (v : F), True -> True -> True -> True -> ((val * (val - 1%F)%F)%F = 0%F) -> True -> True -> ((v = carry_out) -> True).
Proof. hammer. Qed.

Lemma fulladder_obligation6_trivial: forall (bit1 : F) (bit2 : F) (carry : F) (val : F) (u0 : unit) (carry_out : F) (v : F), True -> True -> True -> True -> ((val * (val - 1%F)%F)%F = 0%F) -> True -> True -> ((v = 1%F) -> True).
Proof. hammer. Qed.

Lemma fulladder_obligation7_trivial: forall (bit1 : F) (bit2 : F) (carry : F) (val : F) (u0 : unit) (carry_out : F) (v : F), True -> True -> True -> True -> ((val * (val - 1%F)%F)%F = 0%F) -> True -> True -> ((v = (carry_out - 1%F)%F) -> True).
Proof. hammer. Qed.

Lemma fulladder_obligation8: forall (bit1 : F) (bit2 : F) (carry : F) (val : F) (u0 : unit) (carry_out : F) (u2 : unit) (v : F), True -> True -> True -> True -> ((val * (val - 1%F)%F)%F = 0%F) -> True -> ((carry_out * (carry_out - 1%F)%F)%F = 0%F) -> True -> ((v = val) -> ((^ v) = ((^ ((bit1 + bit2)%F + carry)%F) mod 2%nat)%Z)).
Proof. Admitted.

Lemma fulladder_obligation9: forall (bit1 : F) (bit2 : F) (carry : F) (val : F) (u0 : unit) (carry_out : F) (u2 : unit) (v : F), True -> True -> True -> True -> ((val * (val - 1%F)%F)%F = 0%F) -> True -> ((carry_out * (carry_out - 1%F)%F)%F = 0%F) -> True -> ((v = carry_out) -> ((^ v) = ((^ ((bit1 + bit2)%F + carry)%F) / 2%nat)%Z)).
Proof. Admitted.

Lemma fulladder_obligation10: forall (bit1 : F) (bit2 : F) (carry : F) (val : F) (u0 : unit) (carry_out : F) (u2 : unit), True -> True -> True -> True -> ((val * (val - 1%F)%F)%F = 0%F) -> True -> ((carry_out * (carry_out - 1%F)%F)%F = 0%F) -> (True -> (((2%F * carry_out)%F + val)%F = ((bit1 + bit2)%F + carry)%F)).
Proof. Admitted.

(** ** onlycarry *)

Lemma onlycarry_obligation0_trivial: forall (bit : F) (carry : F) (val : F) (v : F), True -> True -> True -> True -> ((v = val) -> True).
Proof. hammer. Qed.

Lemma onlycarry_obligation1_trivial: forall (bit : F) (carry : F) (val : F) (v : F), True -> True -> True -> True -> ((v = val) -> True).
Proof. hammer. Qed.

Lemma onlycarry_obligation2_trivial: forall (bit : F) (carry : F) (val : F) (v : F), True -> True -> True -> True -> ((v = 1%F) -> True).
Proof. hammer. Qed.

Lemma onlycarry_obligation3_trivial: forall (bit : F) (carry : F) (val : F) (v : F), True -> True -> True -> True -> ((v = (val - 1%F)%F) -> True).
Proof. hammer. Qed.

Lemma onlycarry_obligation4_trivial: forall (bit : F) (carry : F) (val : F) (u0 : unit) (carry_out : F) (v : F), True -> True -> True -> ((val * (val - 1%F)%F)%F = 0%F) -> True -> True -> ((v = carry_out) -> True).
Proof. hammer. Qed.

Lemma onlycarry_obligation5_trivial: forall (bit : F) (carry : F) (val : F) (u0 : unit) (carry_out : F) (v : F), True -> True -> True -> ((val * (val - 1%F)%F)%F = 0%F) -> True -> True -> ((v = carry_out) -> True).
Proof. hammer. Qed.

Lemma onlycarry_obligation6_trivial: forall (bit : F) (carry : F) (val : F) (u0 : unit) (carry_out : F) (v : F), True -> True -> True -> ((val * (val - 1%F)%F)%F = 0%F) -> True -> True -> ((v = 1%F) -> True).
Proof. hammer. Qed.

Lemma onlycarry_obligation7_trivial: forall (bit : F) (carry : F) (val : F) (u0 : unit) (carry_out : F) (v : F), True -> True -> True -> ((val * (val - 1%F)%F)%F = 0%F) -> True -> True -> ((v = (carry_out - 1%F)%F) -> True).
Proof. hammer. Qed.

Lemma onlycarry_obligation8: forall (bit : F) (carry : F) (val : F) (u0 : unit) (carry_out : F) (u2 : unit) (v : F), True -> True -> True -> ((val * (val - 1%F)%F)%F = 0%F) -> True -> ((carry_out * (carry_out - 1%F)%F)%F = 0%F) -> True -> ((v = val) -> ((^ v) = ((^ (bit + carry)%F) mod 2%nat)%Z)).
Proof. Admitted.

Lemma onlycarry_obligation9: forall (bit : F) (carry : F) (val : F) (u0 : unit) (carry_out : F) (u2 : unit) (v : F), True -> True -> True -> ((val * (val - 1%F)%F)%F = 0%F) -> True -> ((carry_out * (carry_out - 1%F)%F)%F = 0%F) -> True -> ((v = carry_out) -> ((^ v) = ((^ (bit + carry)%F) / 2%nat)%Z)).
Proof. Admitted.

Lemma onlycarry_obligation10: forall (bit : F) (carry : F) (val : F) (u0 : unit) (carry_out : F) (u2 : unit), True -> True -> True -> ((val * (val - 1%F)%F)%F = 0%F) -> True -> ((carry_out * (carry_out - 1%F)%F)%F = 0%F) -> (True -> (((2%F * carry_out)%F + val)%F = (bit + carry)%F)).
Proof. Admitted.
...
Proof.
  unwrap_C; intuit; subst; simpl in *; fqsatz.
Qed.
...
Lemma LessThanPower_obligation0_trivial: forall (base : nat) (_in : F) (out : F) (v : F), True -> True -> True -> ((v = out) -> True).
Proof. hammer. Qed.

Lemma LessThanPower_obligation1_trivial: forall (base : nat) (_in : F) (out : F) (v : F), True -> True -> True -> ((v = out) -> True).
Proof. hammer. Qed.

Lemma LessThanPower_obligation2_trivial: forall (base : nat) (_in : F) (out : F) (v : F), True -> True -> True -> ((v = 1%F) -> True).
Proof. hammer. Qed.

Lemma LessThanPower_obligation3_trivial: forall (base : nat) (_in : F) (out : F) (v : F), True -> True -> True -> ((v = (out - 1%F)%F) -> True).
Proof. hammer. Qed.

Lemma LessThanPower_obligation4: forall (base : nat) (_in : F) (out : F) (u : unit) (v : F), True -> True -> ((out * (out - 1%F)%F)%F = 0%F) -> True -> ((v = out) -> (((v = 0%F) \/ (v = 1%F)) /\ (((v = 1%F) -> ((^ _in) < (2%nat ^ base)%Z)) /\ ((v = 0%F) -> ~((^ _in) < (2%nat ^ base)%Z))))).
Proof. Admitted.

(** ** LessThanBounded *)

Lemma LessThanBounded_obligation0: forall (base : nat) (in0 : F) (in1 : F) (v : Z), True -> True -> True -> (((0%nat <= v) /\ (v = base)) -> (0%nat <= v)).
Proof. hammer. Qed.

Lemma LessThanBounded_obligation1_trivial: forall (base : nat) (in0 : F) (in1 : F) (v : F), True -> True -> True -> ((v = in0) -> True).
Proof. hammer. Qed.

Lemma LessThanBounded_obligation2: forall (base : nat) (in0 : F) (in1 : F) (_x : F) (v : Z), True -> True -> (((_x = 0%F) \/ (_x = 1%F)) /\ (((_x = 1%F) -> ((^ in0) < (2%nat ^ base)%Z)) /\ ((_x = 0%F) -> ~((^ in0) < (2%nat ^ base)%Z)))) -> True -> (((0%nat <= v) /\ (v = base)) -> (0%nat <= v)).
Proof. hammer. Qed.

Lemma LessThanBounded_obligation3_trivial: forall (base : nat) (in0 : F) (in1 : F) (_x : F) (v : F), True -> True -> (((_x = 0%F) \/ (_x = 1%F)) /\ (((_x = 1%F) -> ((^ in0) < (2%nat ^ base)%Z)) /\ ((_x = 0%F) -> ~((^ in0) < (2%nat ^ base)%Z)))) -> True -> ((v = in1) -> True).
Proof. hammer. Qed.

Lemma LessThanBounded_obligation4_trivial: forall (base : nat) (in0 : F) (in1 : F) (_x : F) (_y : F) (out : F) (v : F), True -> True -> (((_x = 0%F) \/ (_x = 1%F)) /\ (((_x = 1%F) -> ((^ in0) < (2%nat ^ base)%Z)) /\ ((_x = 0%F) -> ~((^ in0) < (2%nat ^ base)%Z)))) -> (((_y = 0%F) \/ (_y = 1%F)) /\ (((_y = 1%F) -> ((^ in1) < (2%nat ^ base)%Z)) /\ ((_y = 0%F) -> ~((^ in1) < (2%nat ^ base)%Z)))) -> True -> True -> ((v = out) -> True).
Proof. hammer. Qed.

Lemma LessThanBounded_obligation5_trivial: forall (base : nat) (in0 : F) (in1 : F) (_x : F) (_y : F) (out : F) (v : F), True -> True -> (((_x = 0%F) \/ (_x = 1%F)) /\ (((_x = 1%F) -> ((^ in0) < (2%nat ^ base)%Z)) /\ ((_x = 0%F) -> ~((^ in0) < (2%nat ^ base)%Z)))) -> (((_y = 0%F) \/ (_y = 1%F)) /\ (((_y = 1%F) -> ((^ in1) < (2%nat ^ base)%Z)) /\ ((_y = 0%F) -> ~((^ in1) < (2%nat ^ base)%Z)))) -> True -> True -> ((v = out) -> True).
Proof. hammer. Qed.

Lemma LessThanBounded_obligation6_trivial: forall (base : nat) (in0 : F) (in1 : F) (_x : F) (_y : F) (out : F) (v : F), True -> True -> (((_x = 0%F) \/ (_x = 1%F)) /\ (((_x = 1%F) -> ((^ in0) < (2%nat ^ base)%Z)) /\ ((_x = 0%F) -> ~((^ in0) < (2%nat ^ base)%Z)))) -> (((_y = 0%F) \/ (_y = 1%F)) /\ (((_y = 1%F) -> ((^ in1) < (2%nat ^ base)%Z)) /\ ((_y = 0%F) -> ~((^ in1) < (2%nat ^ base)%Z)))) -> True -> True -> ((v = 1%F) -> True).
Proof. hammer. Qed.

Lemma LessThanBounded_obligation7_trivial: forall (base : nat) (in0 : F) (in1 : F) (_x : F) (_y : F) (out : F) (v : F), True -> True -> (((_x = 0%F) \/ (_x = 1%F)) /\ (((_x = 1%F) -> ((^ in0) < (2%nat ^ base)%Z)) /\ ((_x = 0%F) -> ~((^ in0) < (2%nat ^ base)%Z)))) -> (((_y = 0%F) \/ (_y = 1%F)) /\ (((_y = 1%F) -> ((^ in1) < (2%nat ^ base)%Z)) /\ ((_y = 0%F) -> ~((^ in1) < (2%nat ^ base)%Z)))) -> True -> True -> ((v = (out - 1%F)%F) -> True).
Proof. hammer. Qed.

Lemma LessThanBounded_obligation8: forall (base : nat) (in0 : F) (in1 : F) (_x : F) (_y : F) (out : F) (u : unit) (v : F), True -> True -> (((_x = 0%F) \/ (_x = 1%F)) /\ (((_x = 1%F) -> ((^ in0) < (2%nat ^ base)%Z)) /\ ((_x = 0%F) -> ~((^ in0) < (2%nat ^ base)%Z)))) -> (((_y = 0%F) \/ (_y = 1%F)) /\ (((_y = 1%F) -> ((^ in1) < (2%nat ^ base)%Z)) /\ ((_y = 0%F) -> ~((^ in1) < (2%nat ^ base)%Z)))) -> True -> ((out * (out - 1%F)%F)%F = 0%F) -> True -> ((v = out) -> (((v = 0%F) \/ (v = 1%F)) /\ (((v = 1%F) -> ((^ in0) < (^ in1))) /\ ((v = 0%F) -> ~((^ in0) < (^ in1)))))).
Proof. Admitted.
