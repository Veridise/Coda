...
Lemma BigAdd_obligation18: forall (n : nat) (k : nat) (a : (list F)) (b : (list F)), ((n <= (C.k - 1%nat)%Z) /\ ((1%nat <= n) /\ True)) -> (1%nat <= k) -> Forall (fun x117 => ((^ x117) <= ((2%nat ^ n)%Z - 1%nat)%Z)) a -> ((length a) = k) -> Forall (fun x118 => ((^ x118) <= ((2%nat ^ n)%Z - 1%nat)%Z)) b -> ((length b) = k) -> (True -> ((as_le n (nil ++ (0%F :: (nil : F)))) = ((as_le n (a[:0%nat])) + (as_le n (b[:0%nat])))%Z)).
...
Lemma BigAddModP_obligation1: forall (n : nat) (k : nat) (a : (list F)) (b : (list F)) (p : (list F)) (v : Z), ((n <= (C.k - 2%nat)%Z) /\ ((1%nat <= n) /\ True)) -> (1%nat <= k) -> Forall (fun x3 => ((^ x3) <= ((2%nat ^ n)%Z - 1%nat)%Z)) a -> (((as_le n a) <= ((as_le n p) - 1%nat)%Z) /\ ((length a) = k)) -> Forall (fun x4 => ((^ x4) <= ((2%nat ^ n)%Z - 1%nat)%Z)) b -> (((as_le n b) <= ((as_le n p) - 1%nat)%Z) /\ ((length b) = k)) -> Forall (fun x5 => ((^ x5) <= ((2%nat ^ n)%Z - 1%nat)%Z)) p -> ((length p) = k) -> True -> (((v = k) /\ True) -> (1%nat <= v)).
Proof. Admitted.

Lemma BigAddModP_obligation2: forall (n : nat) (k : nat) (a : (list F)) (b : (list F)) (p : (list F)) (v : Z), ((n <= (C.k - 2%nat)%Z) /\ ((1%nat <= n) /\ True)) -> (1%nat <= k) -> Forall (fun x6 => ((^ x6) <= ((2%nat ^ n)%Z - 1%nat)%Z)) a -> (((as_le n a) <= ((as_le n p) - 1%nat)%Z) /\ ((length a) = k)) -> Forall (fun x7 => ((^ x7) <= ((2%nat ^ n)%Z - 1%nat)%Z)) b -> (((as_le n b) <= ((as_le n p) - 1%nat)%Z) /\ ((length b) = k)) -> Forall (fun x8 => ((^ x8) <= ((2%nat ^ n)%Z - 1%nat)%Z)) p -> ((length p) = k) -> True -> (True -> (0%nat <= v)).
Proof. Admitted.

Lemma BigAddModP_obligation3: forall (n : nat) (k : nat) (a : (list F)) (b : (list F)) (p : (list F)) (v : (list F)), ((n <= (C.k - 2%nat)%Z) /\ ((1%nat <= n) /\ True)) -> (1%nat <= k) -> Forall (fun x9 => ((^ x9) <= ((2%nat ^ n)%Z - 1%nat)%Z)) a -> (((as_le n a) <= ((as_le n p) - 1%nat)%Z) /\ ((length a) = k)) -> Forall (fun x10 => ((^ x10) <= ((2%nat ^ n)%Z - 1%nat)%Z)) b -> (((as_le n b) <= ((as_le n p) - 1%nat)%Z) /\ ((length b) = k)) -> Forall (fun x11 => ((^ x11) <= ((2%nat ^ n)%Z - 1%nat)%Z)) p -> ((length p) = k) -> Forall (fun x12 => True) v -> True -> (((v = a) /\ True) -> ((length v) = k)).
Proof. Admitted.

Lemma BigAddModP_obligation4: forall (n : nat) (k : nat) (a : (list F)) (b : (list F)) (p : (list F)) (v : F), ((n <= (C.k - 2%nat)%Z) /\ ((1%nat <= n) /\ True)) -> (1%nat <= k) -> Forall (fun x13 => ((^ x13) <= ((2%nat ^ n)%Z - 1%nat)%Z)) a -> (((as_le n a) <= ((as_le n p) - 1%nat)%Z) /\ ((length a) = k)) -> Forall (fun x14 => ((^ x14) <= ((2%nat ^ n)%Z - 1%nat)%Z)) b -> (((as_le n b) <= ((as_le n p) - 1%nat)%Z) /\ ((length b) = k)) -> Forall (fun x15 => ((^ x15) <= ((2%nat ^ n)%Z - 1%nat)%Z)) p -> ((length p) = k) -> True -> (True -> ((^ v) <= ((2%nat ^ n)%Z - 1%nat)%Z)).
Proof. Admitted.

Lemma BigAddModP_obligation5: forall (n : nat) (k : nat) (a : (list F)) (b : (list F)) (p : (list F)) (v : (list F)), ((n <= (C.k - 2%nat)%Z) /\ ((1%nat <= n) /\ True)) -> (1%nat <= k) -> Forall (fun x16 => ((^ x16) <= ((2%nat ^ n)%Z - 1%nat)%Z)) a -> (((as_le n a) <= ((as_le n p) - 1%nat)%Z) /\ ((length a) = k)) -> Forall (fun x17 => ((^ x17) <= ((2%nat ^ n)%Z - 1%nat)%Z)) b -> (((as_le n b) <= ((as_le n p) - 1%nat)%Z) /\ ((length b) = k)) -> Forall (fun x18 => ((^ x18) <= ((2%nat ^ n)%Z - 1%nat)%Z)) p -> ((length p) = k) -> Forall (fun x19 => True) v -> True -> (((v = b) /\ True) -> ((length v) = k)).
Proof. Admitted.

Lemma BigAddModP_obligation6: forall (n : nat) (k : nat) (a : (list F)) (b : (list F)) (p : (list F)) (v : F), ((n <= (C.k - 2%nat)%Z) /\ ((1%nat <= n) /\ True)) -> (1%nat <= k) -> Forall (fun x20 => ((^ x20) <= ((2%nat ^ n)%Z - 1%nat)%Z)) a -> (((as_le n a) <= ((as_le n p) - 1%nat)%Z) /\ ((length a) = k)) -> Forall (fun x21 => ((^ x21) <= ((2%nat ^ n)%Z - 1%nat)%Z)) b -> (((as_le n b) <= ((as_le n p) - 1%nat)%Z) /\ ((length b) = k)) -> Forall (fun x22 => ((^ x22) <= ((2%nat ^ n)%Z - 1%nat)%Z)) p -> ((length p) = k) -> True -> (True -> ((^ v) <= ((2%nat ^ n)%Z - 1%nat)%Z)).
Proof. Admitted.

Lemma BigAddModP_obligation7: forall (n : nat) (k : nat) (a : (list F)) (b : (list F)) (p : (list F)) (add : (list F)) (v : Z), ((n <= (C.k - 2%nat)%Z) /\ ((1%nat <= n) /\ True)) -> (1%nat <= k) -> Forall (fun x23 => ((^ x23) <= ((2%nat ^ n)%Z - 1%nat)%Z)) a -> (((as_le n a) <= ((as_le n p) - 1%nat)%Z) /\ ((length a) = k)) -> Forall (fun x24 => ((^ x24) <= ((2%nat ^ n)%Z - 1%nat)%Z)) b -> (((as_le n b) <= ((as_le n p) - 1%nat)%Z) /\ ((length b) = k)) -> Forall (fun x25 => ((^ x25) <= ((2%nat ^ n)%Z - 1%nat)%Z)) p -> ((length p) = k) -> Forall (fun x26 => ((^ x26) <= ((2%nat ^ n)%Z - 1%nat)%Z)) add -> (((length add) = (k + 1%nat)%nat) /\ ((as_le n add) = ((as_le n a) + (as_le n b))%Z)) -> True -> (((v = n) /\ True) -> ((0%nat <= v) /\ (v <= (C.k - 1%nat)%Z))).
Proof. Admitted.

Lemma BigAddModP_obligation8_trivial: forall (n : nat) (k : nat) (a : (list F)) (b : (list F)) (p : (list F)) (add : (list F)) (v : Z), ((n <= (C.k - 2%nat)%Z) /\ ((1%nat <= n) /\ True)) -> (1%nat <= k) -> Forall (fun x27 => ((^ x27) <= ((2%nat ^ n)%Z - 1%nat)%Z)) a -> (((as_le n a) <= ((as_le n p) - 1%nat)%Z) /\ ((length a) = k)) -> Forall (fun x28 => ((^ x28) <= ((2%nat ^ n)%Z - 1%nat)%Z)) b -> (((as_le n b) <= ((as_le n p) - 1%nat)%Z) /\ ((length b) = k)) -> Forall (fun x29 => ((^ x29) <= ((2%nat ^ n)%Z - 1%nat)%Z)) p -> ((length p) = k) -> Forall (fun x30 => ((^ x30) <= ((2%nat ^ n)%Z - 1%nat)%Z)) add -> (((length add) = (k + 1%nat)%nat) /\ ((as_le n add) = ((as_le n a) + (as_le n b))%Z)) -> True -> (((v = k) /\ True) -> True).
Proof. intuit. Qed.

Lemma BigAddModP_obligation9_trivial: forall (n : nat) (k : nat) (a : (list F)) (b : (list F)) (p : (list F)) (add : (list F)) (v : Z), ((n <= (C.k - 2%nat)%Z) /\ ((1%nat <= n) /\ True)) -> (1%nat <= k) -> Forall (fun x31 => ((^ x31) <= ((2%nat ^ n)%Z - 1%nat)%Z)) a -> (((as_le n a) <= ((as_le n p) - 1%nat)%Z) /\ ((length a) = k)) -> Forall (fun x32 => ((^ x32) <= ((2%nat ^ n)%Z - 1%nat)%Z)) b -> (((as_le n b) <= ((as_le n p) - 1%nat)%Z) /\ ((length b) = k)) -> Forall (fun x33 => ((^ x33) <= ((2%nat ^ n)%Z - 1%nat)%Z)) p -> ((length p) = k) -> Forall (fun x34 => ((^ x34) <= ((2%nat ^ n)%Z - 1%nat)%Z)) add -> (((length add) = (k + 1%nat)%nat) /\ ((as_le n add) = ((as_le n a) + (as_le n b))%Z)) -> True -> ((v = 1%nat) -> True).
Proof. intuit. Qed.

Lemma BigAddModP_obligation10: forall (n : nat) (k : nat) (a : (list F)) (b : (list F)) (p : (list F)) (add : (list F)) (v : Z), ((n <= (C.k - 2%nat)%Z) /\ ((1%nat <= n) /\ True)) -> (1%nat <= k) -> Forall (fun x35 => ((^ x35) <= ((2%nat ^ n)%Z - 1%nat)%Z)) a -> (((as_le n a) <= ((as_le n p) - 1%nat)%Z) /\ ((length a) = k)) -> Forall (fun x36 => ((^ x36) <= ((2%nat ^ n)%Z - 1%nat)%Z)) b -> (((as_le n b) <= ((as_le n p) - 1%nat)%Z) /\ ((length b) = k)) -> Forall (fun x37 => ((^ x37) <= ((2%nat ^ n)%Z - 1%nat)%Z)) p -> ((length p) = k) -> Forall (fun x38 => ((^ x38) <= ((2%nat ^ n)%Z - 1%nat)%Z)) add -> (((length add) = (k + 1%nat)%nat) /\ ((as_le n add) = ((as_le n a) + (as_le n b))%Z)) -> True -> ((v = (k + 1%nat)%nat) -> ((0%nat <= v) /\ (2%nat <= v))).
Proof. Admitted.

Lemma BigAddModP_obligation11: forall (n : nat) (k : nat) (a : (list F)) (b : (list F)) (p : (list F)) (add : (list F)) (v : (list F)), ((n <= (C.k - 2%nat)%Z) /\ ((1%nat <= n) /\ True)) -> (1%nat <= k) -> Forall (fun x39 => ((^ x39) <= ((2%nat ^ n)%Z - 1%nat)%Z)) a -> (((as_le n a) <= ((as_le n p) - 1%nat)%Z) /\ ((length a) = k)) -> Forall (fun x40 => ((^ x40) <= ((2%nat ^ n)%Z - 1%nat)%Z)) b -> (((as_le n b) <= ((as_le n p) - 1%nat)%Z) /\ ((length b) = k)) -> Forall (fun x41 => ((^ x41) <= ((2%nat ^ n)%Z - 1%nat)%Z)) p -> ((length p) = k) -> Forall (fun x42 => ((^ x42) <= ((2%nat ^ n)%Z - 1%nat)%Z)) add -> (((length add) = (k + 1%nat)%nat) /\ ((as_le n add) = ((as_le n a) + (as_le n b))%Z)) -> Forall (fun x43 => True) v -> True -> (((v = add) /\ True) -> ((length v) = (k + 1%nat)%nat)).
Proof. Admitted.

Lemma BigAddModP_obligation12: forall (n : nat) (k : nat) (a : (list F)) (b : (list F)) (p : (list F)) (add : (list F)) (v : F), ((n <= (C.k - 2%nat)%Z) /\ ((1%nat <= n) /\ True)) -> (1%nat <= k) -> Forall (fun x44 => ((^ x44) <= ((2%nat ^ n)%Z - 1%nat)%Z)) a -> (((as_le n a) <= ((as_le n p) - 1%nat)%Z) /\ ((length a) = k)) -> Forall (fun x45 => ((^ x45) <= ((2%nat ^ n)%Z - 1%nat)%Z)) b -> (((as_le n b) <= ((as_le n p) - 1%nat)%Z) /\ ((length b) = k)) -> Forall (fun x46 => ((^ x46) <= ((2%nat ^ n)%Z - 1%nat)%Z)) p -> ((length p) = k) -> Forall (fun x47 => ((^ x47) <= ((2%nat ^ n)%Z - 1%nat)%Z)) add -> (((length add) = (k + 1%nat)%nat) /\ ((as_le n add) = ((as_le n a) + (as_le n b))%Z)) -> True -> (True -> ((^ v) <= ((2%nat ^ C.k)%Z - 1%nat)%Z)).
Proof. Admitted.

Lemma BigAddModP_obligation13: forall (n : nat) (k : nat) (a : (list F)) (b : (list F)) (p : (list F)) (add : (list F)) (v : (list F)), ((n <= (C.k - 2%nat)%Z) /\ ((1%nat <= n) /\ True)) -> (1%nat <= k) -> Forall (fun x48 => ((^ x48) <= ((2%nat ^ n)%Z - 1%nat)%Z)) a -> (((as_le n a) <= ((as_le n p) - 1%nat)%Z) /\ ((length a) = k)) -> Forall (fun x49 => ((^ x49) <= ((2%nat ^ n)%Z - 1%nat)%Z)) b -> (((as_le n b) <= ((as_le n p) - 1%nat)%Z) /\ ((length b) = k)) -> Forall (fun x50 => ((^ x50) <= ((2%nat ^ n)%Z - 1%nat)%Z)) p -> ((length p) = k) -> Forall (fun x51 => ((^ x51) <= ((2%nat ^ n)%Z - 1%nat)%Z)) add -> (((length add) = (k + 1%nat)%nat) /\ ((as_le n add) = ((as_le n a) + (as_le n b))%Z)) -> Forall (fun x52 => True) v -> True -> (((v = (p ++ (0%F :: (nil: list F)))) /\ ((length v) = ((length p) + (length (0%F :: (nil: list F))))%nat)) -> ((length v) = (k + 1%nat)%nat)).
Proof. Admitted.

Lemma BigAddModP_obligation14: forall (n : nat) (k : nat) (a : (list F)) (b : (list F)) (p : (list F)) (add : (list F)) (v : F), ((n <= (C.k - 2%nat)%Z) /\ ((1%nat <= n) /\ True)) -> (1%nat <= k) -> Forall (fun x53 => ((^ x53) <= ((2%nat ^ n)%Z - 1%nat)%Z)) a -> (((as_le n a) <= ((as_le n p) - 1%nat)%Z) /\ ((length a) = k)) -> Forall (fun x54 => ((^ x54) <= ((2%nat ^ n)%Z - 1%nat)%Z)) b -> (((as_le n b) <= ((as_le n p) - 1%nat)%Z) /\ ((length b) = k)) -> Forall (fun x55 => ((^ x55) <= ((2%nat ^ n)%Z - 1%nat)%Z)) p -> ((length p) = k) -> Forall (fun x56 => ((^ x56) <= ((2%nat ^ n)%Z - 1%nat)%Z)) add -> (((length add) = (k + 1%nat)%nat) /\ ((as_le n add) = ((as_le n a) + (as_le n b))%Z)) -> True -> (True -> ((^ v) <= ((2%nat ^ C.k)%Z - 1%nat)%Z)).
Proof. Admitted.

Lemma BigAddModP_obligation15_trivial: forall (n : nat) (k : nat) (a : (list F)) (b : (list F)) (p : (list F)) (add : (list F)) (lt : F) (v : Z), 
((n <= (C.k - 2%nat)%Z) /\ ((1%nat <= n) /\ True)) -> 
(1%nat <= k) -> Forall (fun x57 => ((^ x57) <= ((2%nat ^ n)%Z - 1%nat)%Z)) a -> 
(((as_le n a) <= ((as_le n p) - 1%nat)%Z) /\ ((length a) = k)) -> 
Forall (fun x58 => ((^ x58) <= ((2%nat ^ n)%Z - 1%nat)%Z)) b -> 
(((as_le n b) <= ((as_le n p) - 1%nat)%Z) /\ ((length b) = k)) -> 
Forall (fun x59 => ((^ x59) <= ((2%nat ^ n)%Z - 1%nat)%Z)) p -> 
((length p) = k) -> Forall (fun x60 => ((^ x60) <= ((2%nat ^ n)%Z - 1%nat)%Z)) add -> 
(((length add) = (k + 1%nat)%nat) /\ 
((as_le n add) = ((as_le n a) + (as_le n b))%Z)) -> 
(((lt = 0%F) \/ (lt = 1%F)) /\ (((lt = 1%F) -> ([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])) /\ ((lt = 0%F) -> ~([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])))) -> True -> (((v = k) /\ True) -> True).
Proof. intuit. Qed.

Lemma BigAddModP_obligation16_trivial: forall (n : nat) (k : nat) (a : (list F)) (b : (list F)) (p : (list F)) (add : (list F)) (lt : F) (v : Z), ((n <= (C.k - 2%nat)%Z) /\ ((1%nat <= n) /\ True)) -> (1%nat <= k) -> Forall (fun x61 => ((^ x61) <= ((2%nat ^ n)%Z - 1%nat)%Z)) a -> (((as_le n a) <= ((as_le n p) - 1%nat)%Z) /\ ((length a) = k)) -> Forall (fun x62 => ((^ x62) <= ((2%nat ^ n)%Z - 1%nat)%Z)) b -> (((as_le n b) <= ((as_le n p) - 1%nat)%Z) /\ ((length b) = k)) -> Forall (fun x63 => ((^ x63) <= ((2%nat ^ n)%Z - 1%nat)%Z)) p -> ((length p) = k) -> Forall (fun x64 => ((^ x64) <= ((2%nat ^ n)%Z - 1%nat)%Z)) add -> (((length add) = (k + 1%nat)%nat) /\ ((as_le n add) = ((as_le n a) + (as_le n b))%Z)) -> (((lt = 0%F) \/ (lt = 1%F)) /\ (((lt = 1%F) -> ([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])) /\ ((lt = 0%F) -> ~([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])))) -> True -> ((v = 1%nat) -> True).
Proof. intuit. Qed.

Lemma BigAddModP_obligation17: forall (n : nat) (k : nat) (a : (list F)) (b : (list F)) (p : (list F)) (add : (list F)) (lt : F) (v : Z), ((n <= (C.k - 2%nat)%Z) /\ ((1%nat <= n) /\ True)) -> (1%nat <= k) -> Forall (fun x65 => ((^ x65) <= ((2%nat ^ n)%Z - 1%nat)%Z)) a -> (((as_le n a) <= ((as_le n p) - 1%nat)%Z) /\ ((length a) = k)) -> Forall (fun x66 => ((^ x66) <= ((2%nat ^ n)%Z - 1%nat)%Z)) b -> (((as_le n b) <= ((as_le n p) - 1%nat)%Z) /\ ((length b) = k)) -> Forall (fun x67 => ((^ x67) <= ((2%nat ^ n)%Z - 1%nat)%Z)) p -> ((length p) = k) -> Forall (fun x68 => ((^ x68) <= ((2%nat ^ n)%Z - 1%nat)%Z)) add -> (((length add) = (k + 1%nat)%nat) /\ ((as_le n add) = ((as_le n a) + (as_le n b))%Z)) -> (((lt = 0%F) \/ (lt = 1%F)) /\ (((lt = 1%F) -> ([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])) /\ ((lt = 0%F) -> ~([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])))) -> True -> ((v = (k + 1%nat)%nat) -> (0%nat <= v)).
Proof. Admitted.

Lemma BigAddModP_obligation18_trivial: forall (n : nat) (k : nat) (a : (list F)) (b : (list F)) (p : (list F)) (add : (list F)) (lt : F) (v : F), ((n <= (C.k - 2%nat)%Z) /\ ((1%nat <= n) /\ True)) -> (1%nat <= k) -> Forall (fun x69 => ((^ x69) <= ((2%nat ^ n)%Z - 1%nat)%Z)) a -> (((as_le n a) <= ((as_le n p) - 1%nat)%Z) /\ ((length a) = k)) -> Forall (fun x70 => ((^ x70) <= ((2%nat ^ n)%Z - 1%nat)%Z)) b -> (((as_le n b) <= ((as_le n p) - 1%nat)%Z) /\ ((length b) = k)) -> Forall (fun x71 => ((^ x71) <= ((2%nat ^ n)%Z - 1%nat)%Z)) p -> ((length p) = k) -> Forall (fun x72 => ((^ x72) <= ((2%nat ^ n)%Z - 1%nat)%Z)) add -> (((length add) = (k + 1%nat)%nat) /\ ((as_le n add) = ((as_le n a) + (as_le n b))%Z)) -> (((lt = 0%F) \/ (lt = 1%F)) /\ (((lt = 1%F) -> ([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])) /\ ((lt = 0%F) -> ~([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])))) -> True -> ((v = 1%F) -> True).
Proof. intuit. Qed.

Lemma BigAddModP_obligation19_trivial: forall (n : nat) (k : nat) (a : (list F)) (b : (list F)) (p : (list F)) (add : (list F)) (lt : F) (v : F), ((n <= (C.k - 2%nat)%Z) /\ ((1%nat <= n) /\ True)) -> (1%nat <= k) -> Forall (fun x73 => ((^ x73) <= ((2%nat ^ n)%Z - 1%nat)%Z)) a -> (((as_le n a) <= ((as_le n p) - 1%nat)%Z) /\ ((length a) = k)) -> Forall (fun x74 => ((^ x74) <= ((2%nat ^ n)%Z - 1%nat)%Z)) b -> (((as_le n b) <= ((as_le n p) - 1%nat)%Z) /\ ((length b) = k)) -> Forall (fun x75 => ((^ x75) <= ((2%nat ^ n)%Z - 1%nat)%Z)) p -> ((length p) = k) -> Forall (fun x76 => ((^ x76) <= ((2%nat ^ n)%Z - 1%nat)%Z)) add -> (((length add) = (k + 1%nat)%nat) /\ ((as_le n add) = ((as_le n a) + (as_le n b))%Z)) -> (((lt = 0%F) \/ (lt = 1%F)) /\ (((lt = 1%F) -> ([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])) /\ ((lt = 0%F) -> ~([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])))) -> True -> (((v = lt) /\ True) -> True).
Proof. intuit. Qed.

Lemma BigAddModP_obligation20_trivial: forall (n : nat) (k : nat) (a : (list F)) (b : (list F)) (p : (list F)) (add : (list F)) (lt : F) (v : F), ((n <= (C.k - 2%nat)%Z) /\ ((1%nat <= n) /\ True)) -> (1%nat <= k) -> Forall (fun x77 => ((^ x77) <= ((2%nat ^ n)%Z - 1%nat)%Z)) a -> (((as_le n a) <= ((as_le n p) - 1%nat)%Z) /\ ((length a) = k)) -> Forall (fun x78 => ((^ x78) <= ((2%nat ^ n)%Z - 1%nat)%Z)) b -> (((as_le n b) <= ((as_le n p) - 1%nat)%Z) /\ ((length b) = k)) -> Forall (fun x79 => ((^ x79) <= ((2%nat ^ n)%Z - 1%nat)%Z)) p -> ((length p) = k) -> Forall (fun x80 => ((^ x80) <= ((2%nat ^ n)%Z - 1%nat)%Z)) add -> (((length add) = (k + 1%nat)%nat) /\ ((as_le n add) = ((as_le n a) + (as_le n b))%Z)) -> (((lt = 0%F) \/ (lt = 1%F)) /\ (((lt = 1%F) -> ([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])) /\ ((lt = 0%F) -> ~([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])))) -> True -> ((v = (1%F - lt)%F) -> True).
Proof. intuit. Qed.

Lemma BigAddModP_obligation21: forall (n : nat) (k : nat) (a : (list F)) (b : (list F)) (p : (list F)) (add : (list F)) (lt : F) (v : (list F)), ((n <= (C.k - 2%nat)%Z) /\ ((1%nat <= n) /\ True)) -> (1%nat <= k) -> Forall (fun x81 => ((^ x81) <= ((2%nat ^ n)%Z - 1%nat)%Z)) a -> (((as_le n a) <= ((as_le n p) - 1%nat)%Z) /\ ((length a) = k)) -> Forall (fun x82 => ((^ x82) <= ((2%nat ^ n)%Z - 1%nat)%Z)) b -> (((as_le n b) <= ((as_le n p) - 1%nat)%Z) /\ ((length b) = k)) -> Forall (fun x83 => ((^ x83) <= ((2%nat ^ n)%Z - 1%nat)%Z)) p -> ((length p) = k) -> Forall (fun x84 => ((^ x84) <= ((2%nat ^ n)%Z - 1%nat)%Z)) add -> (((length add) = (k + 1%nat)%nat) /\ ((as_le n add) = ((as_le n a) + (as_le n b))%Z)) -> (((lt = 0%F) \/ (lt = 1%F)) /\ (((lt = 1%F) -> ([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])) /\ ((lt = 0%F) -> ~([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])))) -> Forall (fun x85 => True) v -> True -> (((v = (p ++ (0%F :: (nil : F)))) /\ ((length v) = ((length p) + (length (0%F :: (nil : F))))%nat)) -> ((length v) = (k + 1%nat)%nat)).
Proof. Admitted.

Lemma BigAddModP_obligation22_trivial: forall (n : nat) (k : nat) (a : (list F)) (b : (list F)) (p : (list F)) (add : (list F)) (lt : F) (v : F), ((n <= (C.k - 2%nat)%Z) /\ ((1%nat <= n) /\ True)) -> (1%nat <= k) -> Forall (fun x86 => ((^ x86) <= ((2%nat ^ n)%Z - 1%nat)%Z)) a -> (((as_le n a) <= ((as_le n p) - 1%nat)%Z) /\ ((length a) = k)) -> Forall (fun x87 => ((^ x87) <= ((2%nat ^ n)%Z - 1%nat)%Z)) b -> (((as_le n b) <= ((as_le n p) - 1%nat)%Z) /\ ((length b) = k)) -> Forall (fun x88 => ((^ x88) <= ((2%nat ^ n)%Z - 1%nat)%Z)) p -> ((length p) = k) -> Forall (fun x89 => ((^ x89) <= ((2%nat ^ n)%Z - 1%nat)%Z)) add -> (((length add) = (k + 1%nat)%nat) /\ ((as_le n add) = ((as_le n a) + (as_le n b))%Z)) -> (((lt = 0%F) \/ (lt = 1%F)) /\ (((lt = 1%F) -> ([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])) /\ ((lt = 0%F) -> ~([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])))) -> True -> (True -> True).
Proof. intuit. Qed.

Lemma BigAddModP_obligation23: forall (n : nat) (k : nat) (a : (list F)) (b : (list F)) (p : (list F)) (add : (list F)) (lt : F) (p' : (list F)) (v : Z), ((n <= (C.k - 2%nat)%Z) /\ ((1%nat <= n) /\ True)) -> (1%nat <= k) -> Forall (fun x90 => ((^ x90) <= ((2%nat ^ n)%Z - 1%nat)%Z)) a -> (((as_le n a) <= ((as_le n p) - 1%nat)%Z) /\ ((length a) = k)) -> Forall (fun x91 => ((^ x91) <= ((2%nat ^ n)%Z - 1%nat)%Z)) b -> (((as_le n b) <= ((as_le n p) - 1%nat)%Z) /\ ((length b) = k)) -> Forall (fun x92 => ((^ x92) <= ((2%nat ^ n)%Z - 1%nat)%Z)) p -> ((length p) = k) -> Forall (fun x93 => ((^ x93) <= ((2%nat ^ n)%Z - 1%nat)%Z)) add -> (((length add) = (k + 1%nat)%nat) /\ ((as_le n add) = ((as_le n a) + (as_le n b))%Z)) -> (((lt = 0%F) \/ (lt = 1%F)) /\ (((lt = 1%F) -> ([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])) /\ ((lt = 0%F) -> ~([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])))) -> Forall (fun x94 => True) p' -> ((forall (scale_j:nat), 0%nat <= scale_j < (k + 1%nat)%nat -> ((p'!scale_j) = ((1%F - lt)%F * ((p ++ (0%F :: (nil : F)))!scale_j))%F)) /\ ((length p') = (k + 1%nat)%nat)) -> True -> (((v = n) /\ True) -> ((0%nat <= v) /\ ((v <= (C.k - 2%nat)%Z) /\ ((1%nat <= v) /\ True)))).
Proof. Admitted.

Lemma BigAddModP_obligation24_trivial: forall (n : nat) (k : nat) (a : (list F)) (b : (list F)) (p : (list F)) (add : (list F)) (lt : F) (p' : (list F)) (v : Z), ((n <= (C.k - 2%nat)%Z) /\ ((1%nat <= n) /\ True)) -> (1%nat <= k) -> Forall (fun x95 => ((^ x95) <= ((2%nat ^ n)%Z - 1%nat)%Z)) a -> (((as_le n a) <= ((as_le n p) - 1%nat)%Z) /\ ((length a) = k)) -> Forall (fun x96 => ((^ x96) <= ((2%nat ^ n)%Z - 1%nat)%Z)) b -> (((as_le n b) <= ((as_le n p) - 1%nat)%Z) /\ ((length b) = k)) -> Forall (fun x97 => ((^ x97) <= ((2%nat ^ n)%Z - 1%nat)%Z)) p -> ((length p) = k) -> Forall (fun x98 => ((^ x98) <= ((2%nat ^ n)%Z - 1%nat)%Z)) add -> (((length add) = (k + 1%nat)%nat) /\ ((as_le n add) = ((as_le n a) + (as_le n b))%Z)) -> (((lt = 0%F) \/ (lt = 1%F)) /\ (((lt = 1%F) -> ([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])) /\ ((lt = 0%F) -> ~([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])))) -> Forall (fun x99 => True) p' -> ((forall (scale_j:nat), 0%nat <= scale_j < (k + 1%nat)%nat -> ((p'!scale_j) = ((1%F - lt)%F * ((p ++ (0%F :: (nil : F)))!scale_j))%F)) /\ ((length p') = (k + 1%nat)%nat)) -> True -> (((v = k) /\ True) -> True).
Proof. intuit. Qed.

Lemma BigAddModP_obligation25_trivial: forall (n : nat) (k : nat) (a : (list F)) (b : (list F)) (p : (list F)) (add : (list F)) (lt : F) (p' : (list F)) (v : Z), ((n <= (C.k - 2%nat)%Z) /\ ((1%nat <= n) /\ True)) -> (1%nat <= k) -> Forall (fun x100 => ((^ x100) <= ((2%nat ^ n)%Z - 1%nat)%Z)) a -> (((as_le n a) <= ((as_le n p) - 1%nat)%Z) /\ ((length a) = k)) -> Forall (fun x101 => ((^ x101) <= ((2%nat ^ n)%Z - 1%nat)%Z)) b -> (((as_le n b) <= ((as_le n p) - 1%nat)%Z) /\ ((length b) = k)) -> Forall (fun x102 => ((^ x102) <= ((2%nat ^ n)%Z - 1%nat)%Z)) p -> ((length p) = k) -> Forall (fun x103 => ((^ x103) <= ((2%nat ^ n)%Z - 1%nat)%Z)) add -> (((length add) = (k + 1%nat)%nat) /\ ((as_le n add) = ((as_le n a) + (as_le n b))%Z)) -> (((lt = 0%F) \/ (lt = 1%F)) /\ (((lt = 1%F) -> ([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])) /\ ((lt = 0%F) -> ~([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])))) -> Forall (fun x104 => True) p' -> ((forall (scale_j:nat), 0%nat <= scale_j < (k + 1%nat)%nat -> ((p'!scale_j) = ((1%F - lt)%F * ((p ++ (0%F :: (nil : F)))!scale_j))%F)) /\ ((length p') = (k + 1%nat)%nat)) -> True -> ((v = 1%nat) -> True).
Proof. intuit. Qed.

Lemma BigAddModP_obligation26: forall (n : nat) (k : nat) (a : (list F)) (b : (list F)) (p : (list F)) (add : (list F)) (lt : F) (p' : (list F)) (v : Z), ((n <= (C.k - 2%nat)%Z) /\ ((1%nat <= n) /\ True)) -> (1%nat <= k) -> Forall (fun x105 => ((^ x105) <= ((2%nat ^ n)%Z - 1%nat)%Z)) a -> (((as_le n a) <= ((as_le n p) - 1%nat)%Z) /\ ((length a) = k)) -> Forall (fun x106 => ((^ x106) <= ((2%nat ^ n)%Z - 1%nat)%Z)) b -> (((as_le n b) <= ((as_le n p) - 1%nat)%Z) /\ ((length b) = k)) -> Forall (fun x107 => ((^ x107) <= ((2%nat ^ n)%Z - 1%nat)%Z)) p -> ((length p) = k) -> Forall (fun x108 => ((^ x108) <= ((2%nat ^ n)%Z - 1%nat)%Z)) add -> (((length add) = (k + 1%nat)%nat) /\ ((as_le n add) = ((as_le n a) + (as_le n b))%Z)) -> (((lt = 0%F) \/ (lt = 1%F)) /\ (((lt = 1%F) -> ([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])) /\ ((lt = 0%F) -> ~([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])))) -> Forall (fun x109 => True) p' -> ((forall (scale_j:nat), 0%nat <= scale_j < (k + 1%nat)%nat -> ((p'!scale_j) = ((1%F - lt)%F * ((p ++ (0%F :: (nil : F)))!scale_j))%F)) /\ ((length p') = (k + 1%nat)%nat)) -> True -> ((v = (k + 1%nat)%nat) -> ((0%nat <= v) /\ (1%nat <= v))).
Proof. Admitted.

Lemma BigAddModP_obligation27: forall (n : nat) (k : nat) (a : (list F)) (b : (list F)) (p : (list F)) (add : (list F)) (lt : F) (p' : (list F)) (v : (list F)), ((n <= (C.k - 2%nat)%Z) /\ ((1%nat <= n) /\ True)) -> (1%nat <= k) -> Forall (fun x110 => ((^ x110) <= ((2%nat ^ n)%Z - 1%nat)%Z)) a -> (((as_le n a) <= ((as_le n p) - 1%nat)%Z) /\ ((length a) = k)) -> Forall (fun x111 => ((^ x111) <= ((2%nat ^ n)%Z - 1%nat)%Z)) b -> (((as_le n b) <= ((as_le n p) - 1%nat)%Z) /\ ((length b) = k)) -> Forall (fun x112 => ((^ x112) <= ((2%nat ^ n)%Z - 1%nat)%Z)) p -> ((length p) = k) -> Forall (fun x113 => ((^ x113) <= ((2%nat ^ n)%Z - 1%nat)%Z)) add -> (((length add) = (k + 1%nat)%nat) /\ ((as_le n add) = ((as_le n a) + (as_le n b))%Z)) -> (((lt = 0%F) \/ (lt = 1%F)) /\ (((lt = 1%F) -> ([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])) /\ ((lt = 0%F) -> ~([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])))) -> Forall (fun x114 => True) p' -> ((forall (scale_j:nat), 0%nat <= scale_j < (k + 1%nat)%nat -> ((p'!scale_j) = ((1%F - lt)%F * ((p ++ (0%F :: (nil : F)))!scale_j))%F)) /\ ((length p') = (k + 1%nat)%nat)) -> Forall (fun x115 => True) v -> True -> (((v = add) /\ True) -> ((length v) = (k + 1%nat)%nat)).
Proof. Admitted.

Lemma BigAddModP_obligation28: forall (n : nat) (k : nat) (a : (list F)) (b : (list F)) (p : (list F)) (add : (list F)) (lt : F) (p' : (list F)) (v : F), ((n <= (C.k - 2%nat)%Z) /\ ((1%nat <= n) /\ True)) -> (1%nat <= k) -> Forall (fun x116 => ((^ x116) <= ((2%nat ^ n)%Z - 1%nat)%Z)) a -> (((as_le n a) <= ((as_le n p) - 1%nat)%Z) /\ ((length a) = k)) -> Forall (fun x117 => ((^ x117) <= ((2%nat ^ n)%Z - 1%nat)%Z)) b -> (((as_le n b) <= ((as_le n p) - 1%nat)%Z) /\ ((length b) = k)) -> Forall (fun x118 => ((^ x118) <= ((2%nat ^ n)%Z - 1%nat)%Z)) p -> ((length p) = k) -> Forall (fun x119 => ((^ x119) <= ((2%nat ^ n)%Z - 1%nat)%Z)) add -> (((length add) = (k + 1%nat)%nat) /\ ((as_le n add) = ((as_le n a) + (as_le n b))%Z)) -> (((lt = 0%F) \/ (lt = 1%F)) /\ (((lt = 1%F) -> ([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])) /\ ((lt = 0%F) -> ~([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])))) -> Forall (fun x120 => True) p' -> ((forall (scale_j:nat), 0%nat <= scale_j < (k + 1%nat)%nat -> ((p'!scale_j) = ((1%F - lt)%F * ((p ++ (0%F :: (nil : F)))!scale_j))%F)) /\ ((length p') = (k + 1%nat)%nat)) -> True -> (True -> ((^ v) <= ((2%nat ^ n)%Z - 1%nat)%Z)).
Proof. Admitted.

Lemma BigAddModP_obligation29: forall (n : nat) (k : nat) (a : (list F)) (b : (list F)) (p : (list F)) (add : (list F)) (lt : F) (p' : (list F)) (v : (list F)), ((n <= (C.k - 2%nat)%Z) /\ ((1%nat <= n) /\ True)) -> (1%nat <= k) -> Forall (fun x121 => ((^ x121) <= ((2%nat ^ n)%Z - 1%nat)%Z)) a -> (((as_le n a) <= ((as_le n p) - 1%nat)%Z) /\ ((length a) = k)) -> Forall (fun x122 => ((^ x122) <= ((2%nat ^ n)%Z - 1%nat)%Z)) b -> (((as_le n b) <= ((as_le n p) - 1%nat)%Z) /\ ((length b) = k)) -> Forall (fun x123 => ((^ x123) <= ((2%nat ^ n)%Z - 1%nat)%Z)) p -> ((length p) = k) -> Forall (fun x124 => ((^ x124) <= ((2%nat ^ n)%Z - 1%nat)%Z)) add -> (((length add) = (k + 1%nat)%nat) /\ ((as_le n add) = ((as_le n a) + (as_le n b))%Z)) -> (((lt = 0%F) \/ (lt = 1%F)) /\ (((lt = 1%F) -> ([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])) /\ ((lt = 0%F) -> ~([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])))) -> Forall (fun x125 => True) p' -> ((forall (scale_j:nat), 0%nat <= scale_j < (k + 1%nat)%nat -> ((p'!scale_j) = ((1%F - lt)%F * ((p ++ (0%F :: (nil : F)))!scale_j))%F)) /\ ((length p') = (k + 1%nat)%nat)) -> Forall (fun x126 => True) v -> True -> (((v = p') /\ True) -> ((length v) = (k + 1%nat)%nat)).
Proof. Admitted.

Lemma BigAddModP_obligation30: forall (n : nat) (k : nat) (a : (list F)) (b : (list F)) (p : (list F)) (add : (list F)) (lt : F) (p' : (list F)) (v : F), ((n <= (C.k - 2%nat)%Z) /\ ((1%nat <= n) /\ True)) -> (1%nat <= k) -> Forall (fun x127 => ((^ x127) <= ((2%nat ^ n)%Z - 1%nat)%Z)) a -> (((as_le n a) <= ((as_le n p) - 1%nat)%Z) /\ ((length a) = k)) -> Forall (fun x128 => ((^ x128) <= ((2%nat ^ n)%Z - 1%nat)%Z)) b -> (((as_le n b) <= ((as_le n p) - 1%nat)%Z) /\ ((length b) = k)) -> Forall (fun x129 => ((^ x129) <= ((2%nat ^ n)%Z - 1%nat)%Z)) p -> ((length p) = k) -> Forall (fun x130 => ((^ x130) <= ((2%nat ^ n)%Z - 1%nat)%Z)) add -> (((length add) = (k + 1%nat)%nat) /\ ((as_le n add) = ((as_le n a) + (as_le n b))%Z)) -> (((lt = 0%F) \/ (lt = 1%F)) /\ (((lt = 1%F) -> ([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])) /\ ((lt = 0%F) -> ~([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])))) -> Forall (fun x131 => True) p' -> ((forall (scale_j:nat), 0%nat <= scale_j < (k + 1%nat)%nat -> ((p'!scale_j) = ((1%F - lt)%F * ((p ++ (0%F :: (nil : F)))!scale_j))%F)) /\ ((length p') = (k + 1%nat)%nat)) -> True -> (True -> ((^ v) <= ((2%nat ^ n)%Z - 1%nat)%Z)).
Proof. Admitted.

Lemma BigAddModP_obligation31_trivial: forall (n : nat) (k : nat) (a : (list F)) (b : (list F)) (p : (list F)) (add : (list F)) (lt : F) (p' : (list F)) (sub : (list F)) (v : Z), ((n <= (C.k - 2%nat)%Z) /\ ((1%nat <= n) /\ True)) -> (1%nat <= k) -> Forall (fun x132 => ((^ x132) <= ((2%nat ^ n)%Z - 1%nat)%Z)) a -> (((as_le n a) <= ((as_le n p) - 1%nat)%Z) /\ ((length a) = k)) -> Forall (fun x133 => ((^ x133) <= ((2%nat ^ n)%Z - 1%nat)%Z)) b -> (((as_le n b) <= ((as_le n p) - 1%nat)%Z) /\ ((length b) = k)) -> Forall (fun x134 => ((^ x134) <= ((2%nat ^ n)%Z - 1%nat)%Z)) p -> ((length p) = k) -> Forall (fun x135 => ((^ x135) <= ((2%nat ^ n)%Z - 1%nat)%Z)) add -> (((length add) = (k + 1%nat)%nat) /\ ((as_le n add) = ((as_le n a) + (as_le n b))%Z)) -> (((lt = 0%F) \/ (lt = 1%F)) /\ (((lt = 1%F) -> ([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])) /\ ((lt = 0%F) -> ~([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])))) -> Forall (fun x136 => True) p' -> ((forall (scale_j:nat), 0%nat <= scale_j < (k + 1%nat)%nat -> ((p'!scale_j) = ((1%F - lt)%F * ((p ++ (0%F :: (nil : F)))!scale_j))%F)) /\ ((length p') = (k + 1%nat)%nat)) -> Forall (fun x137 => ((^ x137) <= ((2%nat ^ n)%Z - 1%nat)%Z)) sub -> ((length sub) = (k + 1%nat)%nat) -> True -> (((v = k) /\ True) -> True).
Proof. intuit. Qed.

Lemma BigAddModP_obligation32: forall (n : nat) (k : nat) (a : (list F)) (b : (list F)) (p : (list F)) (add : (list F)) (lt : F) (p' : (list F)) (sub : (list F)) (v : (list F)), ((n <= (C.k - 2%nat)%Z) /\ ((1%nat <= n) /\ True)) -> (1%nat <= k) -> Forall (fun x138 => ((^ x138) <= ((2%nat ^ n)%Z - 1%nat)%Z)) a -> (((as_le n a) <= ((as_le n p) - 1%nat)%Z) /\ ((length a) = k)) -> Forall (fun x139 => ((^ x139) <= ((2%nat ^ n)%Z - 1%nat)%Z)) b -> (((as_le n b) <= ((as_le n p) - 1%nat)%Z) /\ ((length b) = k)) -> Forall (fun x140 => ((^ x140) <= ((2%nat ^ n)%Z - 1%nat)%Z)) p -> ((length p) = k) -> Forall (fun x141 => ((^ x141) <= ((2%nat ^ n)%Z - 1%nat)%Z)) add -> (((length add) = (k + 1%nat)%nat) /\ ((as_le n add) = ((as_le n a) + (as_le n b))%Z)) -> (((lt = 0%F) \/ (lt = 1%F)) /\ (((lt = 1%F) -> ([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])) /\ ((lt = 0%F) -> ~([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])))) -> Forall (fun x142 => True) p' -> ((forall (scale_j:nat), 0%nat <= scale_j < (k + 1%nat)%nat -> ((p'!scale_j) = ((1%F - lt)%F * ((p ++ (0%F :: (nil : F)))!scale_j))%F)) /\ ((length p') = (k + 1%nat)%nat)) -> Forall (fun x143 => ((^ x143) <= ((2%nat ^ n)%Z - 1%nat)%Z)) sub -> ((length sub) = (k + 1%nat)%nat) -> Forall (fun x144 => True) v -> True -> (((v = (sub[:k])) /\ ((length v) = (length sub))) -> (((as_le n v) = (((as_le n a) + (as_le n b))%Z mod (as_le n p))%Z) /\ ((length v) = k))).
Proof. Admitted.

Lemma BigAddModP_obligation33: forall (n : nat) (k : nat) (a : (list F)) (b : (list F)) (p : (list F)) (add : (list F)) (lt : F) (p' : (list F)) (sub : (list F)) (v : F), ((n <= (C.k - 2%nat)%Z) /\ ((1%nat <= n) /\ True)) -> (1%nat <= k) -> Forall (fun x145 => ((^ x145) <= ((2%nat ^ n)%Z - 1%nat)%Z)) a -> (((as_le n a) <= ((as_le n p) - 1%nat)%Z) /\ ((length a) = k)) -> Forall (fun x146 => ((^ x146) <= ((2%nat ^ n)%Z - 1%nat)%Z)) b -> (((as_le n b) <= ((as_le n p) - 1%nat)%Z) /\ ((length b) = k)) -> Forall (fun x147 => ((^ x147) <= ((2%nat ^ n)%Z - 1%nat)%Z)) p -> ((length p) = k) -> Forall (fun x148 => ((^ x148) <= ((2%nat ^ n)%Z - 1%nat)%Z)) add -> (((length add) = (k + 1%nat)%nat) /\ ((as_le n add) = ((as_le n a) + (as_le n b))%Z)) -> (((lt = 0%F) \/ (lt = 1%F)) /\ (((lt = 1%F) -> ([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])) /\ ((lt = 0%F) -> ~([\ add \] < [\ (p ++ (0%F :: (nil : F))) \])))) -> Forall (fun x149 => True) p' -> ((forall (scale_j:nat), 0%nat <= scale_j < (k + 1%nat)%nat -> ((p'!scale_j) = ((1%F - lt)%F * ((p ++ (0%F :: (nil : F)))!scale_j))%F)) /\ ((length p') = (k + 1%nat)%nat)) -> Forall (fun x150 => ((^ x150) <= ((2%nat ^ n)%Z - 1%nat)%Z)) sub -> ((length sub) = (k + 1%nat)%nat) -> True -> (True -> ((^ v) <= ((2%nat ^ n)%Z - 1%nat)%Z)).
Proof. Admitted.