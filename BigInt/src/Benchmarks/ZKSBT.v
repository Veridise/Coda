...
Lemma IN_obligation0_trivial: forall (valueArraySize : nat) (_in : F) (value : (list F)) (v : Z), ((2%nat < C.q) /\ ((252%nat <= (C.k - 1%nat)%Z) /\ ((0%nat < valueArraySize) /\ ((valueArraySize < C.k) /\ True)))) -> True -> Forall (fun x0 => True) value -> ((length value) = valueArraySize) -> True -> ((v = 0%nat) -> True).
Proof. hammer. Qed.

Lemma IN_obligation1_trivial: forall (valueArraySize : nat) (_in : F) (value : (list F)) (v : nat), ((2%nat < C.q) /\ ((252%nat <= (C.k - 1%nat)%Z) /\ ((0%nat < valueArraySize) /\ ((valueArraySize < C.k) /\ True)))) -> True -> Forall (fun x1 => True) value -> ((length value) = valueArraySize) -> ((((2%nat < C.q) /\ ((252%nat <= (C.k - 1%nat)%Z) /\ ((0%nat < v) /\ ((v < C.k) /\ True)))) /\ (v = valueArraySize)) -> True).
Proof. hammer. Qed.

Lemma IN_obligation2_trivial: forall (valueArraySize : nat) (_in : F) (value : (list F)) (v : Z), ((2%nat < C.q) /\ ((252%nat <= (C.k - 1%nat)%Z) /\ ((0%nat < valueArraySize) /\ ((valueArraySize < C.k) /\ True)))) -> True -> Forall (fun x2 => True) value -> ((length value) = valueArraySize) -> True -> ((0%nat <= v) -> True).
Proof. hammer. Qed.

Lemma IN_obligation3_trivial: forall (valueArraySize : nat) (_in : F) (value : (list F)) (v : Z), ((2%nat < C.q) /\ ((252%nat <= (C.k - 1%nat)%Z) /\ ((0%nat < valueArraySize) /\ ((valueArraySize < C.k) /\ True)))) -> True -> Forall (fun x3 => True) value -> ((length value) = valueArraySize) -> True -> (((0%nat <= v) /\ (v < valueArraySize)) -> True).
Proof. hammer. Qed.

Lemma IN_obligation4_trivial: forall (valueArraySize : nat) (_in : F) (value : (list F)) (i : nat) (v : F), ((2%nat < C.q) /\ ((252%nat <= (C.k - 1%nat)%Z) /\ ((0%nat < valueArraySize) /\ ((valueArraySize < C.k) /\ True)))) -> True -> Forall (fun x4 => True) value -> ((length value) = valueArraySize) -> (i < valueArraySize) -> True -> ((v = (sum_occur i value _in)) -> True).
Proof. hammer. Qed.

Lemma IN_obligation5_trivial: forall (valueArraySize : nat) (_in : F) (value : (list F)) (i : nat) (x : F) (v : F), ((2%nat < C.q) /\ ((252%nat <= (C.k - 1%nat)%Z) /\ ((0%nat < valueArraySize) /\ ((valueArraySize < C.k) /\ True)))) -> True -> Forall (fun x5 => True) value -> ((length value) = valueArraySize) -> (i < valueArraySize) -> (x = (sum_occur i value _in)) -> True -> ((v = _in) -> True).
Proof. hammer. Qed.

Lemma IN_obligation6_trivial: forall (valueArraySize : nat) (_in : F) (value : (list F)) (i : nat) (x : F) (v : F), ((2%nat < C.q) /\ ((252%nat <= (C.k - 1%nat)%Z) /\ ((0%nat < valueArraySize) /\ ((valueArraySize < C.k) /\ True)))) -> True -> Forall (fun x6 => True) value -> ((length value) = valueArraySize) -> (i < valueArraySize) -> (x = (sum_occur i value _in)) -> True -> ((v = (value!i)) -> True).
Proof. hammer. Qed.

Lemma IN_obligation7_trivial: forall (valueArraySize : nat) (_in : F) (value : (list F)) (i : nat) (x : F) (ise : F) (v : F), ((2%nat < C.q) /\ ((252%nat <= (C.k - 1%nat)%Z) /\ ((0%nat < valueArraySize) /\ ((valueArraySize < C.k) /\ True)))) -> True -> Forall (fun x7 => True) value -> ((length value) = valueArraySize) -> (i < valueArraySize) -> (x = (sum_occur i value _in)) -> (((ise = 0%F) \/ (ise = 1%F)) /\ (((ise = 1%F) -> (_in = (value!i))) /\ ((ise = 0%F) -> ~(_in = (value!i))))) -> True -> (((v = (sum_occur i value _in)) /\ (v = x)) -> True).
Proof. hammer. Qed.

Lemma IN_obligation8_trivial: forall (valueArraySize : nat) (_in : F) (value : (list F)) (i : nat) (x : F) (ise : F) (v : F), ((2%nat < C.q) /\ ((252%nat <= (C.k - 1%nat)%Z) /\ ((0%nat < valueArraySize) /\ ((valueArraySize < C.k) /\ True)))) -> True -> Forall (fun x8 => True) value -> ((length value) = valueArraySize) -> (i < valueArraySize) -> (x = (sum_occur i value _in)) -> (((ise = 0%F) \/ (ise = 1%F)) /\ (((ise = 1%F) -> (_in = (value!i))) /\ ((ise = 0%F) -> ~(_in = (value!i))))) -> True -> (((((v = 0%F) \/ (v = 1%F)) /\ (((v = 1%F) -> (_in = (value!i))) /\ ((v = 0%F) -> ~(_in = (value!i))))) /\ (v = ise)) -> True).
Proof. hammer. Qed.

Lemma IN_obligation9: forall (valueArraySize : nat) (_in : F) (value : (list F)) (i : nat) (x : F) (ise : F) (v : F), ((2%nat < C.q) /\ ((252%nat <= (C.k - 1%nat)%Z) /\ ((0%nat < valueArraySize) /\ ((valueArraySize < C.k) /\ True)))) -> True -> Forall (fun x9 => True) value -> ((length value) = valueArraySize) -> (i < valueArraySize) -> (x = (sum_occur i value _in)) -> (((ise = 0%F) \/ (ise = 1%F)) /\ (((ise = 1%F) -> (_in = (value!i))) /\ ((ise = 0%F) -> ~(_in = (value!i))))) -> True -> ((v = (x + ise)%F) -> (v = (sum_occur (i + 1%nat)%nat value _in))).
Proof.
intros. 
...
- unfold sum_occur. replace (i+1)%nat with (S i) by lia. 
  ...
  destruct dec;try fqsatz. exfalso. apply H;auto.
- unfold sum_occur. replace (i+1)%nat with (S i) by lia. 
  rewrite fold_left_firstn_S';try lia.
  destruct dec;try fqsatz. 
Qed.

Lemma IN_obligation10: forall (valueArraySize : nat) (_in : F) (value : (list F)) (v : F), ((2%nat < C.q) /\ ((252%nat <= (C.k - 1%nat)%Z) /\ ((0%nat < valueArraySize) /\ ((valueArraySize < C.k) /\ True)))) -> True -> Forall (fun x10 => True) value -> ((length value) = valueArraySize) -> True -> ((v = 0%F) -> (v = (sum_occur 0%nat value _in))).
Proof. intuit; subst; Signed.solve_to_Z. Qed.

Lemma IN_obligation11: forall (valueArraySize : nat) (_in : F) (value : (list F)) (count : F) (v : Z), ((2%nat < C.q) /\ ((252%nat <= (C.k - 1%nat)%Z) /\ ((0%nat < valueArraySize) /\ ((valueArraySize < C.k) /\ True)))) -> True -> Forall (fun x11 => True) value -> ((length value) = valueArraySize) -> (count = (sum_occur valueArraySize value _in)) -> True -> ((v = 252%nat) -> ((0%nat <= v) /\ (v <= (C.k - 1%nat)%Z))).
Proof. hammer. Qed.

Lemma IN_obligation12: forall (valueArraySize : nat) (_in : F) (value : (list F)) (count : F) (v : F), ((2%nat < C.q) /\ ((252%nat <= (C.k - 1%nat)%Z) /\ ((0%nat < valueArraySize) /\ ((valueArraySize < (2%nat ^ 252%nat)%Z) /\ ((valueArraySize < C.k) /\ True))))) -> True -> Forall (fun x12 => True) value -> ((length value) = valueArraySize) -> (count = (sum_occur valueArraySize value _in)) -> True -> (((v = (sum_occur valueArraySize value _in)) /\ (v = count)) -> ((^ v) <= ((2%nat ^ 252%nat)%Z - 1%nat)%Z)).
Proof.
  unwrap_C;intuit; subst; Signed.solve_to_Z.
  rewrite sum_occur_max; Signed.solve_to_Z.
Qed.

Lemma IN_obligation13: forall (valueArraySize : nat) (_in : F) (value : (list F)) (count : F) (v : F), ((2%nat < C.q) /\ ((252%nat <= (C.k - 1%nat)%Z) /\ ((0%nat < valueArraySize) /\ ((valueArraySize < (2%nat ^ 252%nat)%Z) /\ ((valueArraySize < C.k) /\ True))))) -> True -> Forall (fun x13 => True) value -> ((length value) = valueArraySize) -> (count = (sum_occur valueArraySize value _in)) -> True -> ((v = 0%F) -> ((^ v) <= ((2%nat ^ 252%nat)%Z - 1%nat)%Z)).
Proof. intuit; subst; Signed.solve_to_Z. Qed.

Lemma IN_obligation14: forall (valueArraySize : nat) (_in : F) (value : (list F)) (count : F) (v : F), ((2%nat < C.q) /\ ((252%nat <= (C.k - 1%nat)%Z) /\ ((0%nat < valueArraySize) /\ ((valueArraySize < (2%nat ^ 252%nat)%Z) /\ ((valueArraySize < C.k) /\ True))))) -> True -> Forall (fun x14 => True) value -> ((length value) = valueArraySize) -> (count = (sum_occur valueArraySize value _in)) -> True -> ((((v = 0%F) \/ (v = 1%F)) /\ (((v = 1%F) -> ((^ 0%F) < (^ count))) /\ ((v = 0%F) -> ~((^ 0%F) < (^ count))))) -> (((1%nat <= (^ v)) -> (exists (i:nat), 0%nat <= i < valueArraySize /\ ((value!i) = _in))) /\ ((v = 0%F) -> ~((exists (i:nat), 0%nat <= i < valueArraySize /\ ((value!i) = _in)))))).
Proof. 
  intuit; subst; Signed.solve_to_Z;try easy.
  - apply sum_occur_nonneg in H14;auto.
...
Lemma Query_obligation14: forall (valueArraySize : nat) (_in : F) (value : (list F)) (operator : F) (x : F) (eq : F) (lt : F) (gt : F) (_in : F) (n2b : (list F)) (v : (list F)), ((2%nat < C.q) /\ ((252%nat <= (C.k - 1%nat)%Z) /\ ((0%nat < valueArraySize) /\ ((valueArraySize < (2%nat ^ 252%nat)%Z) /\ True)))) -> ((^ _in) < (2%nat ^ 252%nat)%Z) -> Forall (fun x30 => True) value -> (((^ (value!0%nat)) < (2%nat ^ 252%nat)%Z) /\ ((length value) = valueArraySize)) -> True -> (x = (value!0%nat)) -> (((eq = 0%F) \/ (eq = 1%F)) /\ (((eq = 1%F) -> (_in = x)) /\ ((eq = 0%F) -> ~(_in = x)))) -> (((lt = 0%F) \/ (lt = 1%F)) /\ (((lt = 1%F) -> ((^ _in) < (^ x))) /\ ((lt = 0%F) -> ~((^ _in) < (^ x))))) -> (((gt = 0%F) \/ (gt = 1%F)) /\ (((gt = 1%F) -> ((^ x) < (^ _in))) /\ ((gt = 0%F) -> ~((^ x) < (^ _in))))) -> (((1%nat <= (^ _in)) -> (exists (i:nat), 0%nat <= i < valueArraySize -> ((value!i) = _in))) /\ ((_in = 0%F) -> ~((exists (i:nat), 0%nat <= i < valueArraySize -> ((value!i) = _in))))) -> Forall (fun x31 => ((x31 = 0%F) \/ (x31 = 1%F))) n2b -> (((as_le_f n2b) = operator) /\ ((length n2b) = 3%nat)) -> Forall (fun x32 => True) v -> True -> ((((((((((True /\ ((v!0%nat) = 1%F)) /\ ((v!1%nat) = eq)) /\ ((v!2%nat) = lt)) /\ ((v!3%nat) = gt)) /\ ((v!4%nat) = _in)) /\ ((v!5%nat) = (1%F - _in)%F)) /\ ((v!6%nat) = 0%F)) /\ ((v!7%nat) = 0%F)) /\ ((length v) = 8%nat)) -> ((length v) = 8%nat)).
Proof. hammer. Qed.

Lemma Query_obligation15: forall (valueArraySize : nat) (_in : F) (value : (list F)) (operator : F) (x : F) (eq : F) (lt : F) (gt : F) (_in : F) (n2b : (list F)) (v : (list F)), ((2%nat < C.q) /\ ((252%nat <= (C.k - 1%nat)%Z) /\ ((0%nat < valueArraySize) /\ ((valueArraySize < (2%nat ^ 252%nat)%Z) /\ True)))) -> ((^ _in) < (2%nat ^ 252%nat)%Z) -> Forall (fun x33 => True) value -> (((^ (value!0%nat)) < (2%nat ^ 252%nat)%Z) /\ ((length value) = valueArraySize)) -> True -> (x = (value!0%nat)) -> (((eq = 0%F) \/ (eq = 1%F)) /\ (((eq = 1%F) -> (_in = x)) /\ ((eq = 0%F) -> ~(_in = x)))) -> (((lt = 0%F) \/ (lt = 1%F)) /\ (((lt = 1%F) -> ((^ _in) < (^ x))) /\ ((lt = 0%F) -> ~((^ _in) < (^ x))))) -> (((gt = 0%F) \/ (gt = 1%F)) /\ (((gt = 1%F) -> ((^ x) < (^ _in))) /\ ((gt = 0%F) -> ~((^ x) < (^ _in))))) -> (((1%nat <= (^ _in)) -> (exists (i:nat), 0%nat <= i < valueArraySize -> ((value!i) = _in))) /\ ((_in = 0%F) -> ~((exists (i:nat), 0%nat <= i < valueArraySize -> ((value!i) = _in))))) -> Forall (fun x34 => ((x34 = 0%F) \/ (x34 = 1%F))) n2b -> (((as_le_f n2b) = operator) /\ ((length n2b) = 3%nat)) -> Forall (fun x35 => ((x35 = 0%F) \/ (x35 = 1%F))) v -> True -> (((((as_le_f v) = operator) /\ ((length v) = 3%nat)) /\ (v = n2b)) -> ((length v) = 3%nat)).
Proof. hammer. Qed.

Lemma Query_obligation16: forall (valueArraySize : nat) (_in : F) (value : (list F)) (operator : F) (x : F) (eq : F) (lt : F) (gt : F) (_in : F) (n2b : (list F)) (v : F), ((2%nat < C.q) /\ ((252%nat <= (C.k - 1%nat)%Z) /\ ((0%nat < valueArraySize) /\ ((valueArraySize < (2%nat ^ 252%nat)%Z) /\ True)))) -> ((^ _in) < (2%nat ^ 252%nat)%Z) -> Forall (fun x36 => True) value -> (((^ (value!0%nat)) < (2%nat ^ 252%nat)%Z) /\ ((length value) = valueArraySize)) -> True -> (x = (value!0%nat)) -> (((eq = 0%F) \/ (eq = 1%F)) /\ (((eq = 1%F) -> (_in = x)) /\ ((eq = 0%F) -> ~(_in = x)))) -> (((lt = 0%F) \/ (lt = 1%F)) /\ (((lt = 1%F) -> ((^ _in) < (^ x))) /\ ((lt = 0%F) -> ~((^ _in) < (^ x))))) -> (((gt = 0%F) \/ (gt = 1%F)) /\ (((gt = 1%F) -> ((^ x) < (^ _in))) /\ ((gt = 0%F) -> ~((^ x) < (^ _in))))) -> (((1%nat <= (^ _in)) -> (exists (i:nat), 0%nat <= i < valueArraySize -> ((value!i) = _in))) /\ ((_in = 0%F) -> ~((exists (i:nat), 0%nat <= i < valueArraySize -> ((value!i) = _in))))) -> Forall (fun x37 => ((x37 = 0%F) \/ (x37 = 1%F))) n2b -> (((as_le_f n2b) = operator) /\ ((length n2b) = 3%nat)) -> True -> (((v = 0%F) \/ (v = 1%F)) -> ((v = 0%F) \/ (v = 1%F))).
Proof. hammer. Qed.
...
Lemma getValueByIndex_obligation6: forall (claim : (list F)) (index : F) (n2b : (list F)) (z : (list F)) (v : F), Forall (fun x55 => True) claim -> ((3%nat < C.k) /\ ((length claim) = 8%nat)) -> True -> Forall (fun x56 => ((x56 = 0%F) \/ (x56 = 1%F))) n2b -> (((as_le_f n2b) = index) /\ ((length n2b) = 8%nat)) -> Forall (fun x57 => ((x57 = 0%F) \/ (x57 = 1%F))) z -> ((z = (n2b[:3%nat])) /\ ((length z) = 3%nat)) -> True -> ((v = (claim!(^ (as_le_f z)))) -> (v = (claim!((^ index) mod 8%nat)%Z))).
Proof.
  intuit. subst. simpl in *; subst.
  destruct n2b;try easy. destruct n2b;try easy. destruct n2b;try easy. 
  unfold as_le_f. f_equal.
  erewrite as_le_f_mod with (l2:=n2b);auto.
Qed.
